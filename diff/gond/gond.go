// Package gond The algorithm implemented here is based on "An O(NP) Sequence Comparison Algorithm"
// by described by Sun Wu, Udi Manber and Gene Myers and "An O(ND) Difference Algorithm and Its Variations"
// by EUGENE W. MYERS
package gond
